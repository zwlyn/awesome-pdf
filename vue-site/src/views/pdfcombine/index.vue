        ...
        <el-row class="el-row">
            <el-col :span="8">
                <el-form :inline="true" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    <el-form-item>
                        <el-button style="margin-left: 10px;" size="small" type="success" @click="combinePdf">合并pdf</el-button>
...
<script>
    export default {
        ...
        methods: {
            combinePdf() {
                var _that = this
                this.$axios.get(this.$client.apiUrlprefix() + "/reportmanage/combinePdf", {}, function(res) {
