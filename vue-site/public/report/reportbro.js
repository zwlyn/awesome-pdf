        ...
        value: function registerEventHandlers() {
            ...
            this.el.dblclick(function (event) {
                ...
                if (event.shiftKey) {
                    ...
                    if (_this2.rb.isSelectedObject(_this2.id)) {
                        _this2.rb.getDocument().startDrag(event.originalEvent.pageX, event.originalEvent.pageY, _this2.id, _this2.containerId, _this2.linkedContainerId, _this2.getElementType(), _DocElement3.default.dragType.element);
                    } else {
                        _this2.rb.deselectAll();
                    }
                }
                event.stopPropagation();
            });
...
var TextElement = function (_DocElement) {
    ...
    function TextElement(id, initialData, rb) {
        ...
        _this.backgroundColor = '';
        _this.font = _Style2.default.font.firefly;
        _this.fontSize = 12;
        _this.lineSpacing = 1;
        _this.borderColor = '#000000';
        _this.borderWidth = '1';
        ...
        _this.cs_font = _Style2.default.font.firefly;
...
var ReportBro = function () {
    function ReportBro(element, properties) {
        ...
        this.locale = {
            ...
            contentHeight: '内容高度',
            contentHeightInfo: '仅影响GUI大小以放置元素而不影响实际页面大小',
            docElementAlwaysPrintOnSamePage: '始终在同一页面上',
            docElementBarCode: '条码',
            docElementColor: '颜色',
            docElementConditionalStyle: '有条件的风格',
            ...
            docElementPrintIf: '如果打印',
            docElementPrintSettings: '打印设置',
            docElementRemoveEmptyElement: '空的时候删除',
            docElementRoot: '文档',
            ...
            docElementSpreadsheetColumn: '固定栏',
            ...
            footerDisplay: '显示',
            footerSize: '底部尺寸',
            frameElementShrinkToContentHeight: '收缩到内容高度',
            imageElementImage: '图像文件',
            imageElementLoadErrorMsg: '加载图片失败',
            imageElementSource: '资源',
            header: '头部',
            headerDisplay: '显示',
            headerFooterDisplayAlways: '总是',
            headerFooterDisplayNotOnFirstPage: '第一页不显示',
            headerSize: '头部尺寸',
            ...
            pageFormatLetter: '信件 (8.5 x 11.0 inches)',
            pageFormatUserDefined: '自定义尺寸',
            pageHeight: '高度',
            pageMargins: '页边距',
            pageWidth: '宽度',
            parameter: '参数',
            parameterAddTestData: '增加行',
            parameterArrayItemType: '列出项目类型',
            parameterEditTestData: '标记',
            ...
            patternDate2: '日.月.年 (2位), 小时(24h):分, 例如 1.6.80, 14:30',
            patternDate3: '日/月/年 (月份缩写), 例如 1/Jun/1980',
            patternDate4: '月/日/年, 例如 06/01/1980',
            patternLocale: '本地化',
            patternNumber1: '显示千位分隔符',
            patternNumber2: '显示小数点后跟3位小数',
            patternNumber3: '显示小数点后跟最小值2和最多4位小数',
            patternNumber4: '显示千位分隔符和小数点后跟2位小数',
        ...
        this.properties = {
            ...
            // fonts: [{ name: 'Firefly', value: 'firefly' }],
            fonts: [{ name: 'Courier', value: 'courier' }, { name: 'Helvetica', value: 'helvetica' }, { name: 'Times New Roman', value: 'times' }, { name: 'Firefly', value: 'firefly' }],
    ...
    (0, _createClass3.default)(ReportBro, [{
        ...
        value: function downloadPdf(filename) {
            if (this.reportKey !== null) {
                window.open(this.properties.reportServerUrl + '?key=' + this.reportKey + '&outputFormat=pdf&filename=' + filename, '_blank');
            }
        }
    }]);
    return ReportBro;
...
var MenuPanel = function () {
    ...
    (0, _createClass3.default)(MenuPanel, [{
        ...
        value: function render() {
            ...
            panelLeft.append($('<button id="rbro_menu_json" class="rbroButton rbroMenuButton" title="' + this.rb.getLabel('menuJsonTip') + '">\n                <span class="rbroIcon-code"></span><span class="' + menuButtonClass + '">' + this.rb.getLabel('menuPreview') + '</span></button>').click(function (event) {
                _this.rb.preview();
            }));
